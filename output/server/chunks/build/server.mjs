import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, getCurrentInstance, defineComponent, ref, inject, h, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as sanitizeStatusCode, p as getContext, $ as $fetch, q as createHooks, r as executeAsync, v as getHeader, i as createError$1, x as toRouteMatcher, y as createRouter$1, z as defu, A as setCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CfgA_bKe.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-C-g4cdKj.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DeUz7d7U.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CPRfUqQd.mjs'));
...
export { _export_sfc as _, useSupabaseUser as a, useRouter as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
